...
//                                 <option value="write" onClick={}>직접 입력</option>
...
//                     <button onClick={Final}> 확인용 </button>
//                     /* <JoinUsBtn><NavLink to='/SignCom' onClick={Final} style={({ isActive }) => ({ color: isActive ? 'black' : 'white' })}>회원가입</NavLink></JoinUsBtn><br /> */
//                 <Check>
